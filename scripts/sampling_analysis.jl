...
data.
table_string = "\\epsilon / n_{step}" * prod(" & $n" for n in sort(unique(data.n_step))) * "\\\\ \n "
...
default(lw=4.0,legendfontsize=18.0,guidefontsize=15.0,tickfontsize=15.0,titlefontsize=18.0)
